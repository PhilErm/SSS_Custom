...
fished.disp.friction <- 0.3 # The lower the number, the more individuals will be spread across seascape. Keep between 0 & 1
fished.name <- "fished species"
